...
Coloca aquí la imagen **`turnaround-template.png`** — un turnaround de cuerpo
...
- Ruta esperada por el código: `public/body/turnaround-template.png`
  (se sirve como `/body/turnaround-template.png`).
