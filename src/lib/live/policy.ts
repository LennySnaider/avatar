...
/**
 * LiveAvatar, Anam y todo proveedor de cara en tiempo real prohíbe contenido sexual
...
export const LIVE_LIMITS = {
    ...
    /** El proveedor de cara corta por su cuenta si no llega audio en este tiempo. */
    faceMaxIdleSeconds: 120,
...
const REFUSAL_MESSAGE: Record<SessionStartRefusal, string> = {
    ...
    no_face: 'Este avatar todavía no tiene cara en vivo (pega el face id en la pestaña Live).',
