...
export const MODEL_ACTION_PRESETS: ActionPreset[] = [
    // Basic Poses
    {
        ...
        scene: 'Wearing a soft oversized knit sweater and straight-leg jeans, in a sunlit apartment doorway with warm wood tones behind her.',
    ...
    },
    {
        ...
        scene: 'In a crisp white shirt and wide-leg camel trousers, crossing a city street with glass towers rising behind her.',
        category: 'poses_basic',
        mediaType: 'IMAGE',
    },
    {
    ...
    },
    {
        ...
        scene: 'In a striped linen shirt over a bralette and cutoff shorts, on a sunny cafe terrace with woven chairs.',
        category: 'poses_fashion',
        mediaType: 'IMAGE',
    },
    {
    ...
    // Expressions
    {
        ...
        scene: 'In a soft cream cashmere sweater, in a bright kitchen with morning light across the counter.',
    ...
    },
    {
        ...
        scene: 'In a full tulle skirt of blush pink, in an empty ballroom with tall windows and dusty light.',
        category: 'actions_dynamic',
        mediaType: 'IMAGE',
    },
    {
        ...
        scene: 'In athletic shorts and a bright teal crop top, along a beach boardwalk with the sea behind her.',
        category: 'actions_dynamic',
        mediaType: 'IMAGE',
    },
    {
    ...
    // Interactions
    {
        ...
        scene: 'In a chunky oatmeal cardigan, in a wood-and-brass cafe with warm lamplight.',
    ...
    },
    {
        ...
        scene: 'In a white linen shirt open over a swimsuit, on a sun-blasted marina promenade with yachts behind.',
        category: 'interactions',
        mediaType: 'IMAGE',
    },
    {
        ...
        scene: 'In a tan trench coat and wide-brim felt hat, on an autumn street with amber leaves underfoot.',
        category: 'interactions',
        mediaType: 'IMAGE',
    },
    {
        ...
        scene: 'In silk pyjamas, at a vanity mirror ringed with warm bulbs in a dim bedroom.',
        category: 'interactions',
        mediaType: 'IMAGE',
    },
    ...
    // Video-specific actions
    {
        ...
        scene: 'In a champagne silk gown, in a softly lit hotel suite with sheer curtains.',
        category: 'poses_basic',
        mediaType: 'VIDEO',
    },
    {
    ...
    },
    {
        ...
        scene: 'In a camel trench over an ivory slip, on a wide boulevard at golden hour.',
        category: 'poses_fashion',
        mediaType: 'VIDEO',
    },
    {
        ...
        scene: 'In a soft blush knit, in a bright airy room with a large window behind her.',
        category: 'expressions',
        mediaType: 'VIDEO',
    },
]
